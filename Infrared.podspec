#
#  Be sure to run `pod spec lint infrared.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Uros" => "uros@infrared.io" }
  ...
  s.source       = { :git => "https://github.com/infrared-io/infrared_ios.git", :tag => "0.9.2.3" }
