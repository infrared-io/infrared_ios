...
{
    IRSlider *irSlider = [[IRSlider alloc] init];
    irSlider.descriptor = [[IRSliderDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irSlider];
    return irSlider;
}
