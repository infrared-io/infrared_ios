...
@interface IRCollectionView : UICollectionView <IRComponentInfoProtocol, IRAutoLayoutSubComponentsProtocol, IRCollectionViewExport, IRScrollViewExport, IRViewExport>
