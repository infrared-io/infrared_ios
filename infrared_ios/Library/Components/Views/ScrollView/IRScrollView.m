...
{
    IRScrollView *irScrollView = [[IRScrollView alloc] init];
    irScrollView.descriptor = [[IRScrollViewDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irScrollView];
    return irScrollView;
}
