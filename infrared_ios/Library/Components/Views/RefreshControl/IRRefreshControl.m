...
@implementation IRRefreshControl
...
{
    IRRefreshControl *refreshControl = [[IRRefreshControl alloc] init];
    refreshControl.descriptor = [[IRRefreshControlDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:refreshControl];
