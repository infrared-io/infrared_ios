...
// the underlying attributed string drawn by the version, if set, the version ignores the properties above.
...
@property(nonatomic,getter=isEnabled)                BOOL enabled;                 // default is YES. changes how the version is drawn
...
// these next 3 property allow the version to be autosized to fit a certain width by scaling the font size(s) by a scaling factor >= the minimum scaling factor
...
// version has default content mode of UIViewContentModeRedraw
...
@interface IRLabel : UILabel <IRComponentInfoProtocol, IRLabelExport, IRViewExport>
