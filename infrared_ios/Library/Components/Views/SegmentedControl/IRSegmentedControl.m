...
{
    IRSegmentedControl *irSegmentedControl = [[IRSegmentedControl alloc] init];
    irSegmentedControl.descriptor = [[IRSegmentedControlDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irSegmentedControl];
