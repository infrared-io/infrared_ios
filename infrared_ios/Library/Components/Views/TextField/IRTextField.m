...
{
    IRTextField *irTextField = [[IRTextField alloc] init];
    irTextField.descriptor = [[IRTextFieldDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irTextField];
    return irTextField;
}
