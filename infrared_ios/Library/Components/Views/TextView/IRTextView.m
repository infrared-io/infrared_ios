...
{
    IRTextView *irTextView = [[IRTextView alloc] init];
    irTextView.descriptor = [[IRTextViewDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irTextView];
    return irTextView;
}
