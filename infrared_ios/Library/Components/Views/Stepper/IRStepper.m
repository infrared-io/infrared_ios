...
{
    IRStepper *irStepper = [[IRStepper alloc] init];
    irStepper.descriptor = [[IRStepperDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irStepper];
    return irStepper;
}
