...
{
    IRDatePicker *irDatePicker = [[IRDatePicker alloc] init];
    irDatePicker.descriptor = [[IRDatePickerDescriptor alloc] init];
    [IRBaseBuilder setComponentId:componentId toJSInitComponent:irDatePicker];
    return irDatePicker;
}
